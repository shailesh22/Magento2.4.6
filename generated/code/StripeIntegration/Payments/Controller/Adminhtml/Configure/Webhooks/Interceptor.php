...
class Interceptor extends \StripeIntegration\Payments\Controller\Adminhtml\Configure\Webhooks implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory, \StripeIntegration\Payments\Helper\WebhooksSetup $webhooksSetup)
    {
        $this->___init();
        parent::__construct($resultJsonFactory, $webhooksSetup);
    }
