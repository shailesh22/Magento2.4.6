...
class Interceptor extends \StripeIntegration\Payments\Commands\Webhooks\AutomaticConfigurationCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Config\Model\ResourceModel\Config $resourceConfig, \StripeIntegration\Payments\Helper\AreaCodeFactory $areaCodeFactory)
    {
        $this->___init();
        parent::__construct($resourceConfig, $areaCodeFactory);
    }
